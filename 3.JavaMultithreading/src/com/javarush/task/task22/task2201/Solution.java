...
//        if (string == null && threadName.equals(Solution.FIRST_THREAD_NAME)) {
//            throw new TooShortStringFirstThreadException();
//        } else if (string == null && threadName.equals(Solution.SECOND_THREAD_NAME)) {
//            throw new TooShortStringSecondThreadException();
//        } else if (string == null && !threadName.equals(Solution.FIRST_THREAD_NAME) && !threadName.equals(Solution.SECOND_THREAD_NAME)) {
