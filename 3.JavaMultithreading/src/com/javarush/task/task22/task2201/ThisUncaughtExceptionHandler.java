...
//        return String.format(string, t.getName(), e.getCause().getClass().getSimpleName(), e.getCause());
        return String.format(string, t.getName(), e.getClass().getSimpleName(), e.getCause(),e.getClass().getSimpleName());
    }
}
