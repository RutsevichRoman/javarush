    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int compareRes = ((String) stock1.get("name")).compareToIgnoreCase((String) stock2.get("name"));
                if (compareRes != 0) {
                    return compareRes;
                } else {
                    ...
                    compareRes = ((Integer) date2.getYear()).compareTo(date1.getYear());
                    if (compareRes != 0) return compareRes;
                    compareRes = ((Integer) date2.getMonth()).compareTo(date1.getMonth());
                    if (compareRes != 0) return compareRes;
                    compareRes = ((Integer) date2.getDay()).compareTo(date1.getDay());
                    if (compareRes != 0) return compareRes;
                    if (compareRes != 0) {
                        return compareRes;
                    } else {
                        ...
                        compareRes = change1.compareTo(change2);
                        return compareRes;
                    }
